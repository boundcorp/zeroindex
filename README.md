...
zeroindex-backend-1   backend             3 seconds ago       Up 1 second         8000/tcp
zeroindex-frontend-1  frontend            3 seconds ago       Up 1 second         3000/tcp
zeroindex-ingress-1   ingress             2 seconds ago       Up 1 second         443/tcp, 2019/tcp, 0.0.0.0:7778->80/tcp, :::7778->80/tcp
zeroindex-psql-1      psql                3 seconds ago       Up 2 seconds        5432/tcp
```
...
```
export PROJECT_NAME=zeroindex # Used to name the docker image and docker-compose application
export PROJECT_REGISTRY_IMAGE=ghcr.io/boundcorp/zeroindex # Docker registry for helm deployments
export PYTHON_VERSION=3.10 # 
export DEVELOP_BACKEND_PORT=6677 # Port for the backend to run on - not exposed by default, check compose/dev.yml
...
export KUBE_CLUSTER=zeroindex # Change this to whatever your kubectl cluster context is named
