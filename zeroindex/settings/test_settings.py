...
if "TEST_USE_ENV" not in os.environ:
    ...
    del sys.modules["zeroindex.settings"]
    del sys.modules["zeroindex.settings.project"]

from zeroindex.settings import *
...
EMAIL_BACKEND = "zeroindex.conf.test_settings.MockEmailBackend"
